...
const socialLinks = [
  ...
  { icon: MessageCircle, href: "https://zalo.me/0378304963", label: "Zalo hỗ trợ" },
];
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-[1fr_auto] sm:items-start">
          <div className="min-w-0 max-w-xl">
            ...
            <p className="mt-1.5 text-xs leading-snug break-words text-slate-300">
              Cập nhật đa dạng sản phẩm Windows, Office, Adobe, Autodesk; xử lý đơn nhanh, gửi
              key qua email và đồng hành cùng bạn trong suốt quá trình kích hoạt và sử dụng.
            </p>
          </div>
