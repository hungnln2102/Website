...
export function CheckActivatePanel({
  ...
  return (
    <div
      className={`relative overflow-hidden rounded-3xl border border-purple-400/15 bg-slate-950/55 p-4 shadow-xl shadow-purple-950/15 transition-opacity duration-500 sm:p-6 lg:rounded-none lg:border-0 lg:bg-transparent lg:p-8 lg:shadow-none ${
        isCheckMode
    ...
    >
      ...
      <div className="relative flex h-full flex-col justify-center">
        ...
        <p className="mt-4 rounded-2xl border border-sky-400/15 bg-sky-400/5 px-3 py-3 text-center text-xs text-slate-400 lg:hidden">
          Cần nhận OTP?{' '}
          <button onClick={onSwitchToOtp} className="font-semibold text-sky-400 hover:text-sky-300">
            Nhận OTP →
          </button>
        </p>
      </div>
